//提示层的HTML
var onShowHtml = '<P class="noticeWrap"><B class="ico-show"></B><SPAN class=txt-show>$data$</SPAN></P>';
var onFocusHtml = '<P class="noticeWrap"><B class="ico-focus"></B><SPAN class=txt-show>$data$</SPAN></P>';
