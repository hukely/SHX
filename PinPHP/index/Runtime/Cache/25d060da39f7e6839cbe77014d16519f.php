...
<div class="uc clearfix">
    <div class="album_nav mt20">
        ...
        <a class="link" href="<?php echo u('album/index');?>">专辑</a>/
        <a href="<?php echo uc('uc/album');?>"><?php echo ($info["album_who"]); ?></a>/
        <a><?php echo ($info["album_title"]); ?></a>
    </div>    	
...
<?php endif; ?>    
    ...
    <?php if($show_sp == 1): ?><div id="more" class="center"> 
            <a href="<?php echo u('album/details',array('sp'=>2,'cid'=>$cid,'p'=>$p,'uid'=>$uid,'id'=>$info['album_id']));?>" hidefocus="true"></a> 
       	</div><?php endif; ?>
    <?php if($page != ''): ?><div id="page" class="page mt20 clearfix" style="display: none;"> <span class="page_num"><?php echo ($page); ?></span> </div><?php endif; ?>
     </div>
</div>
<div class="footer">
