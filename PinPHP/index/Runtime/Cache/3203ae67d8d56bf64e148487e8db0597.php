	...
	<div class="m-nav">
		<div class="layout980 clearfix pos-r">
			...
			<div class="shareIt fr">
				<!-- <div id="share_goods" class="left top_share"><div class="button">分享宝贝</div></div> -->
				<div class="btn-sg">分享好东西<span class="arrow-dn"></span></div>
            ...
            <form id="myform" name="myform" action="" method="post" onsubmit="return check();">
                <table class="mt10">
                    <tr>
                        <th>帐号 :</th>
                        <td>
                        	<input type="text" id="name" name="name" class="input_text" size="20" value="邮箱/会员帐号"  onMouseOver="this.focus()" onMouseOut="if(this.value=='')this.value='邮箱/会员帐号';" onFocus="this.select()" onClick="if(this.value=='邮箱/会员帐号')this.value=''"/>
