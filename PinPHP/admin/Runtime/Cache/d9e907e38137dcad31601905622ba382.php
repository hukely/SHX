...
<div class="pad-10" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><a class="blue" href="<?php echo u('article/edit', array('id'=>$val['id']));?>"><?php echo ($val["id"]); ?></a></td>
    ...
    <div class="btn">
    	...
    	<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='<?php echo u("article/sort_order");?>'" value="<?php echo (L("sort_order")); ?>" style="float:left;"/>
