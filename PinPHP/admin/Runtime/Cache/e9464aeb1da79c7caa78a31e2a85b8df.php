...
<div class="pad-lr-10" >
    <form id="myform" name="myform" action="<?php echo u('article_cate/delete');?>" method="post" onsubmit="return check();">
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($article_cate_list['parent'])): $i = 0; $__LIST__ = $article_cate_list['parent'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><em style="color:green;"><?php echo ($val["id"]); ?></em></td>
        	...
        	<?php if(is_array($article_cate_list['sub'][$val['id']])): $i = 0; $__LIST__ = $article_cate_list['sub'][$val['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sval): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><em style="color:green;"><?php echo ($sval["id"]); ?></em></td>
                <td align="left"><?php echo ($sval["seo_title"]); ?></td>
				<td align="center"><em style="color:red;"><?php echo ($sval["article_nums"]); ?></em></td>
                <td align="center"><input type="text" class="input-text-c input-text" value="<?php echo ($sval["sort_order"]); ?>" size="4" name="listorders[<?php echo ($sval["id"]); ?>]"></td>
    ...
    <input type="submit" class="button" name="dosubmit" onclick="document.myform.action='<?php echo u("article_cate/sort_order");?>'" value="<?php echo (L("sort_order")); ?>"/>
    </div>
