...
$config->APPID		= '216032';	//应用ID，请自行申请
$config->APIKey		= WB_AKEY;	//你的API Key，请自行申请
$config->SecretKey	= WB_SKEY;	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= WB_CALLBACK_URL;//你的获取code的回调地址，也是accesstoken的回调地址
